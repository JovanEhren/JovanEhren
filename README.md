...
I build small, focused tools that fix  annoying problem i encountered — a PDF utility, a couple of websites, scraping scripts. Comfortable across TypeScript, Python, and Kotlin, picking whichever fits the job. Currently exploring local-first tooling and Android side projects.
