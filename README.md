...
I build small, focused tools that fix  annoying problem i ecountered — a PDF utility, an Android image cleaner, a couple of scraping scripts. Comfortable across TypeScript, Python, and Kotlin, picking whichever fits the job. Currently exploring local-first tooling and Android side projects.
